...
<div class="card-header">
    ...
    <span class="float-md-right"><a href="{{ route('laravel-faker-generator.create') }}" class="btn btn-info">Back</a></span>
</div>
...
<div class="card-body">
    <form action="{{ route('laravel-faker-generator.generate.faker', [ 'table' => $table ]) }}" method="post">
        ...
        <div class="form-group">
            ...
            <input type="number" class="form-control" id="rows" value="100">
